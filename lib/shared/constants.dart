...
class Gradients {
  ...
  static Color startColor = Colors.deepOrange[400];
  static Color endColor = Color(0xFFFFDE7D);
  ...
  static LinearGradient dashboardButtonGradient = LinearGradient(
      ...
      colors: [Colors.deepOrange[400], Color(0xFFFFDE7D)]);
  ...
  static const LinearGradient sosGradient = LinearGradient(
    ...
    // radius: 0.5,
    colors: <Color>[Colors.deepOrange, Color(0xFFFFDE7D)],
    tileMode: TileMode.repeated,
  );

  static const Color mainColor = Color(0xFFFFDE7D);
                      ...
                      child: AlertDialog(
                        ...
                        content: Container(
                          ...
                          decoration: BoxDecoration(
                              shape: BoxShape.circle, color: Color(0xFFFFDE7D)),
...
class Constants {
  ...
  static Function sendMessage = () async {
    ...
    String message =
        "Hey, Help me! I'm in an emergency. I'm at (${first.featureName}, ${first.addressLine}).";
    List<String> recipents = ["8778318778"];
